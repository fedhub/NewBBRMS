...
mobile_authentication_routers.post('/update-customer-details&:customer_type&:phone_number_updated', function(req, res){
    ...
    if(!phone_number_updated) mobile_authentication_functions.update_customer_phone_same(req, res);
    if(phone_number_updated) mobile_authentication_functions.update_customer_phone_changed(req, res);
});
